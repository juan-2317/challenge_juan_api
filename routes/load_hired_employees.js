...
router.post('/load_hired_employees/import-csv', upload.single('file'), (req, res) => { // 'file': Hace referencia al name del html
        ...
        .on('end', function() { // 'end': Evento que se dispara al final para finalmente insertar los datos en MySQL
            ...
            pool.getConnection((error, connection) => {
                if (error) {
                    ...
                    let query = "INSERT INTO hired_employees(id, name, datetime, department_id, job_id) VALUES ?";
...
router.get('/load_hired_employees', (req, res, next) => {
    res.render("load_hired_employees.ejs");
});
